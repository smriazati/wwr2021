...
?>
    ...
    <section class="clinic-services">
        <div class="wrapper grid-fixed">
            ...
            <div class="card">
                <div class="text-wrapper">
                    <h3><?php echo $service7['name'] ?></h3>
                    <p><?php echo $service7['description'] ?></p>
                </div>
            </div>
            <div class="card">
                <div class="text-wrapper">
                    <h3><?php echo $service8['name'] ?></h3>
                    <p><?php echo $service8['description'] ?></p>
                </div>
            </div>
    ...
    <section id="featured-pages-section" class="featured-pages clinic-featured-pages">
